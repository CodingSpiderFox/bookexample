...
/**
 * Criteria class for the {@link com.example.test.domain.Author} entity. This class is used
 * in {@link com.example.test.web.rest.AuthorResource} to receive all the possible filtering options from
